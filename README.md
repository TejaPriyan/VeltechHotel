...
> Modern full-stack hotel management and luxury reservation platform designed and developed by **Teja Priyan** (Tejapriyan).
...
* **Guest Account Portal**: Secure user authentication with profile management and complete booking history.

### 🛡️ Administrative Dashboard
* **Booking Management**: Centralized admin portal to view, approve, and manage customer reservations.
* **Room Inventory Control**: Real-time status management for suite availability and maintenance.
* **User & Security Access**: Role-based access control (RBAC) protecting administrative routes and actions.
